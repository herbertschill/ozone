# Test of function 'splinefun' Interpolating Splines
# Description
...
# (from 'R_Reference_Manual.pdf' page 1348ff)
...
x <- xmin:xmax
y <- rnorm(nxs)
xspl <- seq(xmin,xmax, by = 0.25)
svsch <- spline(x, y, xout=xspl)
plot(x, y, main = paste("spline[fun](.) through", nxs, "points"))
lines(spline(x, y))
#lines(spline(x, y, n = 201), col = 2)
lines(spline(x, y, xout=xsch), col = 3)
x;y;xsch;svsch
